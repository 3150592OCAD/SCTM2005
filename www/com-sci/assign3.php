...
<html>
<head>
	<title>Assign 3 | Com-Sci | Nic Hull</title>
...
<body>
	<header role="banner" id="banner">
        <nav id="static-navbar" role="navigation">
            <ul>
                <li><a href="assign2.php" title="Blog posts: Previous Assignment" class="hidden-link"> Pervious</a></li>
