...
<html>
<head>
	<title>Assign 2 | Media | Nic Hull</title>
...
<body>
	<header role="banner" id="banner">
        <nav id="static-navbar" role="navigation">
            <ul>
            	<li><a href="assign1.php" title="Blog posts: Previous Assignment" class="hidden-link"> Previous</a></li>
                <li><a href="assign3.php" title="Blog posts: Next Assignment" class="hidden-link"> Next</a></li>
