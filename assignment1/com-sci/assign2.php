...
<html>
<head>
	<title>Assign 2 | Com-Sci | Nic Hull</title>
...
<body>
	<header role="banner" id="banner">
        <nav id="static-navbar" role="navigation">
            <ul>
            	<li><a href="assign1.php" title="Posts: Previous Assignment" class="hidden-link"> Previous</a></li>
                <li><a href="assign3.php" title="Posts: Next Assignment" class="hidden-link"> Next</a></li>
